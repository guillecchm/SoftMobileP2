...
/**
* La clase {@code Cuenta} representa una cuenta bancaria, que ha de tener al menos un (@see {@link edu.uclm.esi.iso2.banco20193capas.model.Cliente}) que sea titular.
* 
* 
*/
@Entity
